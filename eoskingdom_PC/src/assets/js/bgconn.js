export default{
    ...
    DEZHOU:'https://eoskingdom.io/webgame/pkIndex.html?master=base&timestamp=',
    //交易所行情
    ...
    // DICE游戏
    //获取下注列表
    getresults:"https://eoskingdom.io/dice/getresults",
    // 获取验证信息
    getbetdata:"https://eoskingdom.io/dice/getbetdata",
    // 获取我的下注列表
    getMyBet:"https://eoskingdom.io/api/app/dice/diceUserBet",
    // 获取排行榜信息
    get24Rank:"https://eoskingdom.io/api/app/dice/diceBetRanking",
    // 跳转链接去验证
    toCheck:"https://www.eosx.io/tx/",
    // 获取总投注额
    getAllBet:"https://eoskingdom.io/api/app/dice/diceBetTotal",
    // 获取幸运数字榜单
    getluckyPlayer:"https://eoskingdom.io/api/app/dice/luckyDiceRanking",
    // 获取推荐人幸运数字榜单
    getluckyPlayer:"https://eoskingdom.io/api/app/dice/luckyDiceRanking",
    // 获取推荐人
    getreference:"https://eoskingdom.io/api/app/invitationCode/queryReffer",
}
