<template>
  <div id="hero_outer">
    <div id="flip-counter" class="flip-counter" data-date="2019-5-25 16:30:00"></div>
  </div>
</template>
      ...
      for (i = 0; i < count; i++){
        ...
        if (bit != (count)){
          if (bit % 3 == 0 && !o.dateFormat) {
            ...
            newComma = doc.createElement("ul");
            newComma.className = 'cd';
            newComma.innerHTML = '<li class="s date_separate"></li>';
            div.insertBefore(newComma, div.firstChild);
          }
        }
        bit++;
