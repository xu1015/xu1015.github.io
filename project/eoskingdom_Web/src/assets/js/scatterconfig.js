 ...
 export function confignode(){
  var code=[]
    ...
    var s=new Date().getTime()   
      ...
      // console.log('e3=='+JSON.stringify(e))
      }); 
      ...
      https.get('https://mainnet.meet.one',function(res){
        ...
        resolve(code)
          ...
          // console.log('e4=='+JSON.stringify(e))
      }); 
      ...
      // console.log('e5=='+JSON.stringify(e))
      }); 
      ...
      // console.log('e6=='+JSON.stringify(e))
      }); 
      ...
      // console.log('e7=='+JSON.stringify(e))
      }); 
    ...
    resolve(code)
      ...
      // console.log('e8=='+JSON.stringify(e))
      }); 
     })
 }
